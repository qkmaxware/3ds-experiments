...
void Screen::StampString(const std::string& text, int x, int y, int scale, Colour foreground, Colour background) {
    int xPtr = x;
    for (char c : text) {
        Screen::StampGlyph(Typeface::DefaultFont[c], xPtr, y, scale, foreground, background);
        xPtr += scale * Typeface::Width + Typeface::Kerning;
    }
}
...
Font _makeDefaultFont() {
    ...
    result['@'] = Glyph{{0x7e,0x81,0x9d,0xa5,0xa5,0x9d,0x85,0x76,0x00,0x00,0x00,0x00}};
    result['|'] = Glyph{{0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x00,0x00,0x00,0x00}};
    result['='] = Glyph{{0x00,0x00,0x7e,0x00,0x7e,0x00,0x00,0x00,0x00,0x00,0x00,0x00}};
    result['_'] = Glyph{{0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x7e,0x00,0x00,0x00,0x00}};
    result['['] = Glyph{{0x70,0x40,0x40,0x40,0x40,0x40,0x40,0x70,0x00,0x00,0x00,0x00}};
    result[']'] = Glyph{{0x0e,0x02,0x02,0x02,0x02,0x02,0x02,0x0e,0x00,0x00,0x00,0x00}};
    result['\''] = Glyph{{0x10,0x10,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}};
    result['\"'] = Glyph{{0x14,0x14,0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}};
    result['`'] = Glyph{{0x40,0x20,0x10,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}};
    result['?'] = Glyph{{0x3c,0x04,0x04,0x1c,0x10,0x10,0x00,0x10,0x00,0x00,0x00,0x00}};
...
void MultiStateCitrusApp::loop(Displays &displays, Input &input) {
    // Trigger before doing any state
    before_loop(displays, input);
